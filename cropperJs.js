...
function Handle(position, constraints, cursor, eventBus) {
  ...
  function onMouseMove(e) {
    ...
    self.eventBus.dispatchEvent(new CustomEvent('handlemove', {
      detail: { mouseX: xAxis, mouseY: yAxis }
    }));
  }
};
...
var CropprCore = function () {
  ...
  createClass(CropprCore, [{
    ...
    value: function attachRegionEvents() {
      ...
      this.regionEl.addEventListener('touchstart', onMouseDown);
    ...
    value: function attachOverlayEvents() {
      ...
      this.overlayEl.addEventListener('touchstart', onMouseDown);
      function onMouseDown(e) {
        e.stopPropagation();
        e.preventDefault();
        document.addEventListener('mouseup', onMouseUp);
        ...
        var mouseX = xAxis- container.left;
        var mouseY = yAxis - container.top;
        tmpBox = self.box;
